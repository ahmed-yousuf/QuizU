                        ...
                        children: [
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: SizedBox(
                                    ...
                                    width: 20,
                                    child: Text(
                                      lController.topUserList![0].name
                                          .toString(),
                                ...
                                Positioned(
                                  ...
                                  child: Text(
                                    lController.topUserList![0].score
                                        .toString(),
                                    textAlign: TextAlign.center,
                                    style: poppinsMedium.copyWith(
                                ...
                                Positioned(
                                  ...
                                  child: SizedBox(
                                    ...
                                    width: 110,
                                    child: Text(
                                      lController.topUserList![1].name
                                          .toString(),
                                      textAlign: TextAlign.center,
                                      style: poppinsMedium.copyWith(
                                        color: Colors.white,
                                ...
                                Positioned(
                                  ...
                                  child: SizedBox(
                                    ...
                                    width: 110,
                                    child: Text(
                                      lController.topUserList![2].name
                                          .toString(),
                                      textAlign: TextAlign.center,
                                      style: poppinsMedium.copyWith(
                                        color: Colors.white,
                            ...
                            Expanded(
                              child: ListView.separated(
                                  itemCount:
                                      lController.topUserList!.length - 3,
